    ...
    <>
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Resumen del estado actual de los estudiantes registrados.
        </p>
      </div>
      ...
      <div className="rounded-xl border border-amber-200 bg-amber-50 dark:border-amber-900/40 dark:bg-amber-950/20 p-4">
        <p className="text-sm text-amber-800 dark:text-amber-300">
          <strong>Aviso:</strong> Esta herramienta es un prototipo de apoyo pedagógico (MVP).
          No reemplaza el criterio profesional del docente ni constituye una evaluación oficial.
          Todos los datos de estudiantes son <strong>ficticios</strong>.
        </p>
      </div>
    </>
  );
